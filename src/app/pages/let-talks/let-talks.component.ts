...
@Component({
  selector: 'app-let-talks',
  templateUrl: './let-talks.component.html',
  styleUrls: ['./let-talks.component.scss']
})
export class LetTalksComponent implements OnInit {
  ...
  submitDetails() {
    ...
    if (this.name && this.email && this.phoneNumber && this.aFormGroup.value.recaptcha) {
      ...
      this.service.dataSubmit(request, 'letTalk').subscribe((result) => {
